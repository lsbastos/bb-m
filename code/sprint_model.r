...
saveRDS(tbl.total.uf.train1, file = "~/Desktop/tbl.total.uf.train1.rds")
saveRDS(tbl.total.uf.train2, file = "~/Desktop/tbl.total.uf.train2.rds")
saveRDS(tbl.total.uf.week.train1, file = "~/Desktop/tbl.total.uf.week.train1.rds")
saveRDS(tbl.total.uf.week.train2, file = "~/Desktop/tbl.total.uf.week.train2.rds")
